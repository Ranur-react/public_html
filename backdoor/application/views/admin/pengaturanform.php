...
<form id="pengaturan">
	...
	<div class="row">
		<div class="col-md-6 m-b-20">
			...
			<div class="form-group m-t-20">
				<label><b>WARNA DASAR WEBSITE</b></label>
			</div>
			<div class="btn-group g-warna col-12 m-lr-0 form-group m-b-10 col-md-6 m-b-30" role="group">
				...
				?>
				<button id="light" onclick="$('#temawarna').val(1);$('.g-warna button').removeClass('btn-success');$('.g-warna button').addClass('btn-light');$(this).removeClass('btn-light');$(this).addClass('btn-success');" type="button" style="border: 1px solid #bbb;" class="col-6 btn btn-sm <?=$light?>"><b>LIGHT</b></button>
				<button id="dark" onclick="$('#temawarna').val(2);$('.g-warna button').removeClass('btn-success');$('.g-warna button').addClass('btn-light');$(this).removeClass('btn-light');$(this).addClass('btn-success');" type="button" style="border: 1px solid #bbb;" class="col-6 btn btn-sm <?=$dark?>"><b>DARK</b></button>
			</div>
		</div>
		<div class="col-md-6 m-b-20">
			<div class="logoset">
