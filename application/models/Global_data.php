...
class Global_data extends CI_Model{
	...
	function tema($pilih=null){
		$warna = [
			...
			[
				"light"=>"linear-gradient( 109.5deg,  rgb(240, 14, 19) 11.2%, rgb(216, 19, 137) 91.1% )",
				"hover"=>"linear-gradient( 109.5deg,  rgba(211, 158, 18,1) 11.2%, rgb(217, 22, 126) 91.1% )",
				"testimoni"=>"radial-gradient( circle farthest-corner at 10% 90%,  rgb(240, 14, 19,0.2) 0.1%, rgba(216, 19, 137,0.2) 90.1% )",
				"foot"=>"rgba(255, 209, 234,1)",
				"foot_gradient"=>"linear-gradient( 0deg,  rgba(255, 209, 234,1) 0%, rgb(242, 243, 248) 100% )"
			],
		];
