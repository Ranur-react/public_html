	...
	<footer class="bg-foot p-t-45 p-b-43" style="margin-top: -2px;">
		...
		<div class="t-center p-l-15 p-r-15">
			<div class="t-center p-t-20">
				 <a href="<?= coprightLink() ?>">Copyright © 2021 <?= coprightLable();//ucwords(strtolower($set->nama))?> </a>
	...
	<?php }else{ ?>
	<a href="https://wa.me/<?=$this->func->getRandomWasap()?>" class="chat-sticky" target="_blank"><i class="fas fa-comment-dots"></i> Live Chat</a>
	<?php }?>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="p-all-28 text-center">
						...
						<small>atau</small><br/>
						<b class="text-success fs-20 font-medium">085691257411&nbsp;</b>
						<br/>&nbsp;<br/>
