	...
	<form class="bg0 p-t-40 p-b-85" id="cekout">
        ...
        <div class="sticky col-md-4 m-l-auto m-r-auto m-b-50">
          ...
          <div class="section p-lr-24 p-tb-30 m-l-0 m-l-0 p-r-15 p-l-15">
            <div class="metode m-b-40">
              <div class="font-bold text-primary text-center fs-18 m-b-20">METODE PEMBAYARAN</div>
              <input type="hidden" id="metode_bayar" value="0" name="metode_bayar" />
              <div class="m-b-12 row m-lr-0 metodebayar" id="bayarcod" data-metode="1" data-bayar="cod">
              ...
              <div class="m-b-12 row m-lr-0 metodebayar" id="bayartransfer" data-metode="2" data-bayar="transfer">
                <div class="col-md-6 p-lr-0">
              ...
              <div class="m-b-12 row m-lr-0 metodebayar" id="bayaripaymu" data-metode="3" data-bayar="ipaymu">
                <div class="col-md-6 p-lr-0">
                  <div class="bg-logo p-all-4"><img src="<?=base_url("assets/images/ipaymu-white.png")?>" style="width:100%" /></div>
                </div>
                <div class="col-md-6">
                  <small>VA, Gopay, OVO, Alfamart dll</small>
                </div>
              </div>
              <div class="m-b-12 row m-lr-0 metodebayar" id="bayarmidtrans" data-metode="4" data-bayar="midtrans">
                <div class="col-md-6 p-lr-0">
