			...
			<div class="m-t-20">
				<table class="table table-sm table-bordered">
					...
					<tr>
						...
						<th colspan=2 class="text-right">Ongkir <?=strtoupper(strtolower($this->func->getKurir($trx->paket,"nama")." ".$this->func->getPaket($trx->kurir,"nama")))?></th>
						<th class="text-right"><?=$this->func->formUang($trx->ongkir)?></th>
					</tr>
					<tr>
						<th colspan=2 class="text-right">Biaya COD</th>
						<th class="text-right"><?=$this->func->formUang($trx->biaya_cod)?></th>
					</tr>
					<tr>
					...
					<tr>
						...
						<th class="text-right"><?=$this->func->formUang($total+$trx->biaya_cod+$trx->ongkir-$byr->diskon)?></th>
					</tr>
				</table>
			</div>
		<?php
