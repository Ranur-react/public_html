...
<h4 class="page-title m-b-20">Daftar Sales Booster Custom</h4>

<div class="m-b-60">
	<div class="card">
		<div class="card-header row align-items-center">
			<div class="card-title col-md-8 m-b-10">
				<a href="javascript:tambahSB()" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah Booster</a>
			</div>
			<div class="col-md-4">
